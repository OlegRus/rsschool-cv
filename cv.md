...
- [telegram](https://t.me/olegrus178)
- [github](https://github.com/OlegRus)

##  О себе
Я вляюсь QA инженером в направлении "автоматизация тестирования". Тестированием занимаюсь с 2015 года. Могу писать на различных языках программирования Python, Java, Rust, Go...

## Навыки

`Python` `Rust` `Bash` `Java` `Go` `CI` `Git`

#### Курсы

* [Програмирование на языке C++](https://stepik.org/cert/111180)
